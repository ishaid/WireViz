...
class Cable(TopLevelGraphicalComponent):
    ...
    def __post_init__(self) -> None:
        ...
        self.bgcolor_title = SingleColor(self.bgcolor_title)
        self.color = MultiColor(self.color)
        self.casing_color = MultiColor(self.casing_color)
        ...
        if self.show_wirenumbers is None:
            # by default, show wire numbers for cables, hide for bundles or multi-lead
            self.show_wirenumbers = self.category not in ("bundle", "multi-lead")
